        ...
        if shared_layerwise_retrieve:
            ...
            for candidate_index, (start, end, key) in enumerate(candidates):
                ...
                page_planned = (
                    ...
                    else batch_plan is not None and len(keys) < len(batch_plan)
                )
                planned = remote_fill_chunk is not None or page_planned
                keys_multi_layer = (
                    [key] * self.num_layers
                    if page_planned
                ...
                planned_location = (
                    ...
                    if page_planned and batch_plan is not None
                    else None
                )
